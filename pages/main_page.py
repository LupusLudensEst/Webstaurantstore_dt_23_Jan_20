...
class MainPage(Page):
    ...
    CART_BTN = (By.CSS_SELECTOR, "span.btn.btn-small.btn-primary")
    EMPTY_CROSS_SIGN = (By.CSS_SELECTOR, "a.deleteCartItemButton.close")
    CART_EMPTY_BLOCK = (By.CSS_SELECTOR, "div.cartEmpty")
    ...
    def verify_cart_is_empty(self):
        ...
        """
        self.wait_for_element_to_be_visible(*self.CART_EMPTY_BLOCK)
